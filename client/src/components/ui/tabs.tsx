...
// Кастомный компонент для нашего дизайна
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "border-b border-neutral-200 flex flex-wrap -mb-px",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-block p-4 text-sm font-medium text-center text-neutral-500 hover:text-neutral-700 border-b-2 border-transparent hover:border-neutral-300 mr-2",
